...
export function renderUserProfileModal(showModal, currentUser) {
      ...
      <div class="modal-box" style="max-width: 480px; width: 95%;">
        ...
        <form id="profile-edit-form">
          <div style="margin-bottom: 16px;">
            ...
            <input type="text" value="${currentUser.role || 'ADMIN'}" disabled style="width: 100%; padding: 10px; background: rgba(0,0,0,0.3); color: var(--accent-cyan); font-weight: 800; border: 1px solid var(--border-subtle); border-radius: 6px;">
          </div>

          <div style="margin-bottom: 16px;">
            <label style="font-size: 0.8rem; color: var(--text-muted); font-weight: 700; display: block; margin-bottom: 4px;">Nome & Cognome:*</label>
            <input type="text" id="profile-name" value="${currentUser.name || ''}" required style="width: 100%; padding: 10px; background: var(--bg-primary); color: #fff; border: 1px solid var(--border-color); border-radius: 6px; font-weight: 700;">
          </div>
          ...
          <div style="margin-bottom: 16px;">
            ...
            <input type="text" id="profile-username" value="${currentUser.username || ''}" required disabled style="width: 100%; padding: 10px; background: rgba(0,0,0,0.3); color: #fff; border: 1px solid var(--border-color); border-radius: 6px; font-weight: 700; font-family: monospace;">
          </div>

          <div style="margin-bottom: 16px;">
            <label style="font-size: 0.8rem; color: var(--text-muted); font-weight: 700; display: block; margin-bottom: 4px;">Email:</label>
            <input type="email" id="profile-email" value="${currentUser.email || ''}" style="width: 100%; padding: 10px; background: var(--bg-primary); color: #fff; border: 1px solid var(--border-color); border-radius: 6px;">
          </div>

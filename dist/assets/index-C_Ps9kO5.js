(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=new class{async sendWelcomeEmail(e){let t=a.getRoleLabels()[e.role]||e.role,n=a.getSettings(),r=e.email||`${e.username}@deconto.it`,i=`👋 Benvenuto nel Team ${n.brandTitle||`DECONTO`} - Credenziali di Accesso`,o=`Ciao ${e.name},\n\nBenvenuto a bordo nel team per il progetto ${n.brandTitle||`DECONTO`}!\n\nRuolo Assegnato: ${t}\nCodice Accesso: ${e.username}\nPassword: ${e.password||`123456`}\nPiattaforma: https://deconto-app.web.app\n\nBuon lavoro!\nIl Team DECONTO System`,s=`
    ...
    `,c=`mailto:${encodeURIComponent(r)}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(o)}`,l={id:`mail_`+Date.now(),type:`WELCOME_NEW_USER`,recipientEmail:r,recipientName:e.name,subject:i,plainTextBody:o,htmlBody:s,mailtoUrl:c,timestamp:new Date().toISOString(),status:`SENT_TO_OUTBOX`};return a.data.emailLogs||(a.data.emailLogs=[]),a.data.emailLogs.unshift(l),a.saveData(),this.trySendRealEmailViaEmailJS(l),l}async sendRoleUpdateEmail(e,t,n){let r=a.getRoleLabels(),i=r[t]||t,o=r[n]||n,s=a.getSettings(),c=e.email||`${e.username}@deconto.it`,l=`🎉 Aggiornamento Ruolo Operativo & Nuovi Permessi - ${s.brandTitle||`DECONTO`}`,u=`Ciao ${e.name},\n\nIl tuo ruolo ed i tuoi permessi su ${s.brandTitle||`DECONTO`} sono stati aggiornati!\n\nRuolo Precedente: ${i}\nNuovo Ruolo: ${o}\n\nAccedi alla piattaforma per le nuove funzionalità: https://deconto-app.web.app\n\nBuon lavoro!\nLa Direzione DECONTO System`,d=`
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0f172a; color: #f8fafc; padding: 24px; border-radius: 16px; border: 1px solid #334155;">
        <div style="text-align: center; margin-bottom: 24px; border-bottom: 1px solid #334155; padding-bottom: 16px;">
      ...
      <div class="stat-card" style="margin-top: 24px; padding: 24px;">
        ...
        <form id="settings-emailjs-form" style="display: grid; grid-template-columns: 1fr 1fr 1fr auto; gap: 16px; align-items: end;">
          <div>
            ...
            <input type="text" id="setting-emailjs-service" value="${e.emailjsServiceId||``}" placeholder="Es. service_xyz123" style="width: 100%; padding: 10px; background: var(--bg-primary); color: #fff; border: 1px solid var(--border-color); border-radius: 6px;">
          </div>
          ...
          <div>
            ...
            <input type="text" id="setting-emailjs-template" value="${e.emailjsTemplateId||``}" placeholder="Es. template_abc456" style="width: 100%; padding: 10px; background: var(--bg-primary); color: #fff; border: 1px solid var(--border-color); border-radius: 6px;">
          </div>
          ...
          <div>
            ...
            <input type="text" id="setting-emailjs-key" value="${e.emailjsPublicKey||``}" placeholder="Es. user_pubkey789" style="width: 100%; padding: 10px; background: var(--bg-primary); color: #fff; border: 1px solid var(--border-color); border-radius: 6px;">
          </div>

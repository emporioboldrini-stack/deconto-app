        ...
        <div class="modal-box" style="max-width: 1240px; width: 96%; min-height: 80vh; max-height: 90vh; overflow-y: auto;">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; margin-bottom: 24px;">
            ...
            <div style="background: rgba(0,0,0,0.3); padding: 16px; border-radius: 12px; border: 1px solid var(--border-subtle);">
              ...
              ${(()=>{let e={Bar:`#f59e0b`,Ristorante:`#ef4444`,Hotel:`#8b5cf6`,"Azienda/Ufficio":`#38bdf8`,"Palestra/Sport":`#22c55e`,"Negozio/Retail":`#f97316`,"Struttura Sanitaria":`#06b6d4`,"Scuola/Università":`#a78bfa`,Altro:`#6b7280`},t={};f.forEach(e=>{let n=e.clientType||`Altro`;t[n]=(t[n]||0)+1});let n=Object.entries(t).sort((e,t)=>t[1]-e[1]),r=n.length>0?n[0][1]:1;return n.length===0?`<div style="color:var(--text-muted);font-size:0.85rem;">Nessun cliente registrato.</div>`:n.map(([t,n])=>{let i=Math.round(n/g*100),a=Math.round(n/r*100),o=e[t]||`#6b7280`;return`
                    <div style="margin-bottom: 12px;">
                      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px; font-size: 0.85rem;">
                        <span style="font-weight: 700; color: #fff;">${t}</span>
                        <span style="color: ${o}; font-weight: 800;">${n} client${n===1?`e`:`i`} &nbsp;<small style="color:var(--text-muted);">(${i}%)</small></span>
                      </div>
                      <div style="background: rgba(255,255,255,0.06); border-radius: 4px; height: 6px; width: 100%;">
                        <div style="background: ${o}; height: 6px; border-radius: 4px; width: ${a}%; transition: width 0.4s;"></div>
                      </div>
                    </div>
                  `}).join(``)})()}
            </div>
